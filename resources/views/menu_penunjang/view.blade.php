...
<div class="card shadow bg-white flex-row card-rounded">
    <div class="card-body my-auto">
        <div class="title">
            ...
            <span class="fw-bold fs-5">VIEW MENU PENUNJANG</span>
            <hr>
        </div>
        <main>
            <section class="intro">
                        ...
                        <div class="col-md-12">
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="kategori_kegiatan" id="kategori_kegiatan" class="form-control form-select" data-bs-toggle="dropdown" disabled>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="nama_kegiatan" type="text" class="form-control @error('nama_kegiatan') is-invalid @enderror" name="nama_kegiatan" required value="{{ $menu_penunjang->nama_kegiatan }}" disabled>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="pelaksanaan" type="date" class="form-control @error('pelaksanaan') is-invalid @enderror datepicker" name="pelaksanaan" required value="{{ $menu_penunjang->pelaksanaan }}" disabled>
