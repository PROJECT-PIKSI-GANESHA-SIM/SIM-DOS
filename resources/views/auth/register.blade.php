        ...
        <div>
            <div class="card shadow bg-white flex-row card-rounded ">
                <div class="bg-custom-primary card-rounded-left image">
                    <img src="{{ asset('assets/register.svg') }}" class="mb-5 px-5 m-auto" alt="" height="400px" height="400px" style="display: block; margin: 0 auto;">
                ...
                <div class="card-body my-auto">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label mx-5">{{ __('Confirm Password') }}</label>
    
                            <div class="mx-5">
                                <input id="password-confirm" type="password" class="form-control @error('password-confirm') is-invalid @enderror" name="password-confirm" value="{{ old('password-confirm') }}" required autocomplete="password" autofocus>
                            </div>
                        </div>
    {{-- 
                        <div class="mb-2">
