    ...
    <div class="container pt-4 pb-5 text-white">
        <div class="row">
            ...
            <div class="col-md-6 text-md-end">
                <a href="https://www.twitter.com/idcamp_indosat" class="btn mx-2 btn-tw" target="_blank"
                    rel="noreferrer">
                    <svg role="img" width="36" height="36" viewBox="0 0 24 24"
                        xmlns="https://fontawesome.com/icons/facebook?f=brands&s=solid&pc=%23ffffff">
                ...
                <a href="https://www.facebook.com/IDCampIOH" class="btn mx-2 btn-fb" target="_blank" rel="noreferrer">
                    <svg role="img" width="36" height="36" viewBox="0 0 24 24"
                ...
                <a href="https://www.instagram.com/idcamp" class="btn mx-2 btn-ig" target="_blank" rel="noreferrer">
                    <svg role="img" width="36" height="36" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
                        <title>Youtube</title>
                        <path
        ...
        <div class="row mt-4">
            <div class="col">
                <span class="text-white">©POLITEKNIK PIKSI GANESHA, 2023. All Rights Reserved</span>
            </div>
        </div>
    </div>
</footer>
