            ...
            <section class="intro">
                <form method="POST" action="{{ route('penelitian.update', $penelitian->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3 ">
                                <label for="tahun_kegiatan" class="col-md-4 col-form-label">{{ __('Tahun Kegiatan') }}</label> <span class="text-danger" style="margin-left: -3px">*</span>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3 ">
                                <label for="lama_kegiatan" class="col-md-4 col-form-label">{{ __('lama Kegiatan') }}</label> <span class="text-danger" style="margin-left: -8px">*</span>
