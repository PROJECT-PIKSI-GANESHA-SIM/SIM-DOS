...
<div class="card shadow bg-white flex-row card-rounded">
    <div class="card-body my-auto">
        <div class="title">
            ...
            <span class="fw-bold fs-5">DETAIL PENELITIAN</span>
            <hr>
        </div>
        <main>
            <section class="intro">
                <form method="POST" action="{{ route('penelitian.update', $penelitian->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="status_peneliti" id="status_peneliti" class="form-control form-select" data-bs-toggle="dropdown" disabled>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3 ">
                                ...
                                <input id="kelompok_bidang" type="text" class="form-control @error('kelompok_bidang') is-invalid @enderror" name="kelompok_bidang" required value="{{ $penelitian->kelompok_bidang }}" disabled>
                    ...
                    <div class="mb-3 ">
                        ...
                        <textarea id="judul_penelitian" type="text" class="form-control @error('judul_penelitian') is-invalid @enderror" name="judul_penelitian" required style="height: 100px;" disabled>{{ $penelitian->judul_penelitian }}</textarea>
                    ...
                    <div class="mb-3 ">
                        ...
                        <input id="lokasi_kegiatan" type="text" class="form-control @error('lokasi_kegiatan') is-invalid @enderror" name="lokasi_kegiatan" required value="{{ $penelitian->lokasi_kegiatan }}" disabled>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3 ">
                                ...
                                <input id="tahun_usulan" type="text" class="form-control @error('tahun_usulan') is-invalid @enderror" name="tahun_usulan" required value="{{ $penelitian->tahun_usulan }}" disabled>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3 ">
                                ...
                                <input id="tahun_kegiatan" type="text" class="form-control @error('tahun_kegiatan') is-invalid @enderror" name="tahun_kegiatan" required value="{{ $penelitian->tahun_kegiatan }}" disabled>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3 ">
                                ...
                                <input id="lama_kegiatan" type="text" class="form-control @error('lama_kegiatan') is-invalid @enderror" name="lama_kegiatan" required value="{{ $penelitian->lama_kegiatan }}" disabled>
                    ...
                    <div class="mb-3">
                        ...
                        <input id="jumlah_dana" type="text" class="form-control @error('jumlah_dana') is-invalid @enderror" name="jumlah_dana" required value="{{ $penelitian->jumlah_dana }}" disabled>
                    ...
                    <div class="mb-3">
                        ...
                        <input id="sumber_dana" type="text" class="form-control @error('sumber_dana') is-invalid @enderror" name="sumber_dana" required value="{{ $penelitian->sumber_dana }}" disabled>
                    ...
                    <div class="mb-3">
                        ...
                        <input id="no_sk_penugasan" type="text" class="form-control @error('no_sk_penugasan') is-invalid @enderror" name="no_sk_penugasan" required value="{{ $penelitian->nomor_sk_penugasan }}" disabled>
                    ...
                    <div class="mb-3">
                        ...
                        <input id="tanggal_sk_penugasan" type="date" class="form-control @error('tanggal_sk_penugasan') is-invalid @enderror datepicker" name="tanggal_sk_penugasan" required value="{{ $penelitian->tanggal_sk_penugasan }}" disabled>
                    ...
                    <div class="mb-3">
                        ...
                        <input id="link_publikasi" type="text" class="form-control @error('link_publikasi') is-invalid @enderror" name="link_publikasi" required value="{{ $penelitian->link_publikasi }}" disabled>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control @error('publikasi') is-invalid @enderror" name="publikasi" disabled>
