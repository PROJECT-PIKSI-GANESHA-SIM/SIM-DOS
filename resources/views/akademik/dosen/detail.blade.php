...
@section('content')
    <ul class="nav nav-tabs card-header-tabs justify-content-end mb-0" id="myTab" role="tablist">
        <li class="nav-item">
            <a class="nav-link active bg-primary text-white" id="tab1-tab" data-bs-toggle="tab" href="#tab1" role="tab"
                aria-controls="tab1" aria-selected="true">Data Diri</a>
        </li>
        <li class="nav-item">
            <a class="nav-link bg-white text-black" id="tab2-tab" data-bs-toggle="tab" href="#tab2" role="tab"
                aria-controls="tab2" aria-selected="false">Pendidikan</a>
        </li>
        <li class="nav-item">
            <a class="nav-link bg-white text-black" id="tab3-tab" data-bs-toggle="tab" href="#tab3" role="tab"
                aria-controls="tab3" aria-selected="false">Pengajaran</a>
        </li>
        <li class="nav-item">
            <a class="nav-link bg-white text-black" id="tab4-tab" data-bs-toggle="tab" href="#tab4" role="tab"
                aria-controls="tab4" aria-selected="false">Penelitian</a>
        </li>
        <li class="nav-item">
            <a class="nav-link bg-white text-black" id="tab5-tab" data-bs-toggle="tab" href="#tab5" role="tab"
                aria-controls="tab5" aria-selected="false">Pengabdian</a>
        </li>
        <li class="nav-item">
            <a class="nav-link bg-white text-black" id="tab6-tab" data-bs-toggle="tab" href="#tab6" role="tab"
                aria-controls="tab6" aria-selected="false">Penunjang</a>
        </li>
        <li class="nav-item">
            <a class="nav-link bg-white text-black" id="tab7-tab" data-bs-toggle="tab" href="#tab7" role="tab"
                aria-controls="tab7" aria-selected="false">Capaian Luaran</a>
        </li>
    </ul>
    <div class="card">
        <div class="card-body">
                                            ...
                                            <table class="table table-striped mb-0">
                                                ...
                                                <tbody>
                                                    @if ($pendidikan->isEmpty())
                                                        <tr>
                                                            <td colspan="7" class="text-center py-3">Tidak Ada Data
                                                            </td>
                                                        </tr>
                                                    @else()
                                    ...
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination">
                                            ...
                                            <li class="page-item {{ $pendidikan->onFirstPage() ? 'disabled' : '' }}">
                                                <a class="page-link" href="{{ $pendidikan->previousPageUrl() }}"
                                                    aria-label="Previous">
                                            ...
                                            @for ($i = 1; $i <= $pendidikan->lastPage(); $i++)
                                                <li
                                                    class="page-item {{ $pendidikan->currentPage() == $i ? 'active' : '' }}">
                                                    <a class="page-link"
                                                        href="{{ $pendidikan->url($i) }}">{{ $i }}</a>
                                                </li>
                                            @endfor

                                            <!-- Tombol "Next" -->
                                            <li
                                                class="page-item {{ $pendidikan->currentPage() == $pendidikan->lastPage() ? 'disabled' : '' }}">
                                                <a class="page-link" href="{{ $pendidikan->nextPageUrl() }}"
                                                    aria-label="Next">
                                            ...
                                            <table class="table table-striped mb-0">
                                                ...
                                                <tbody>
                                                    @if ($pengajaran->isEmpty())
                                                        <tr>
                                                            <td colspan="8" class="text-center py-3">Tidak Ada Data
                                                            </td>
                                                        </tr>
                                                    @endif
                                    ...
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination">
                                            ...
                                            <li class="page-item {{ $pengajaran->onFirstPage() ? 'disabled' : '' }}">
                                                <a class="page-link" href="{{ $pengajaran->previousPageUrl() }}"
                                                    aria-label="Previous">
                                                    <span aria-hidden="true">Previous</span>
                                                    <span class="sr-only">Previous</span>
                                                </a>
                                            ...
                                            @for ($i = 1; $i <= $pengajaran->lastPage(); $i++)
                                                <li
                                                    class="page-item {{ $pengajaran->currentPage() == $i ? 'active' : '' }}">
                                                    <a class="page-link"
                                                        href="{{ $pengajaran->url($i) }}">{{ $i }}</a>
                                                </li>
                                            @endfor

                                            <!-- Tombol "Next" -->
                                            <li
                                                class="page-item {{ $pengajaran->currentPage() == $pengajaran->lastPage() ? 'disabled' : '' }}">
                                                <a class="page-link" href="{{ $pengajaran->nextPageUrl() }}"
                                                    aria-label="Next">
                                                    <span aria-hidden="true">Next</span>
                                                    <span class="sr-only">Next</span>
                                                </a>
                                    ...
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination">
                                            ...
                                            <li class="page-item {{ $penelitian->onFirstPage() ? 'disabled' : '' }}">
                                                <a class="page-link" href="{{ $penelitian->previousPageUrl() }}"
                                                    aria-label="Previous">
                                                    <span aria-hidden="true">Previous</span>
                                                    <span class="sr-only">Previous</span>
                                                </a>
                                            ...
                                            @for ($i = 1; $i <= $penelitian->lastPage(); $i++)
                                                <li
                                                    class="page-item {{ $penelitian->currentPage() == $i ? 'active' : '' }}">
                                                    <a class="page-link"
                                                        href="{{ $penelitian->url($i) }}">{{ $i }}</a>
                                                </li>
                                            @endfor

                                            <!-- Tombol "Next" -->
                                            <li
                                                class="page-item {{ $penelitian->currentPage() == $penelitian->lastPage() ? 'disabled' : '' }}">
                                                <a class="page-link" href="{{ $penelitian->nextPageUrl() }}"
                                                    aria-label="Next">
                                                    <span aria-hidden="true">Next</span>
                                                    <span class="sr-only">Next</span>
                                                </a>
                                    ...
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination">
                                            ...
                                            <li class="page-item {{ $pengabdian->onFirstPage() ? 'disabled' : '' }}">
                                                <a class="page-link" href="{{ $pengabdian->previousPageUrl() }}"
                                                    aria-label="Previous">
                                                    <span aria-hidden="true">Previous</span>
                                                    <span class="sr-only">Previous</span>
                                                </a>
                                            ...
                                            @for ($i = 1; $i <= $pengabdian->lastPage(); $i++)
                                                <li
                                                    class="page-item {{ $pengabdian->currentPage() == $i ? 'active' : '' }}">
                                                    <a class="page-link"
                                                        href="{{ $pengabdian->url($i) }}">{{ $i }}</a>
                                                </li>
                                            @endfor

                                            <!-- Tombol "Next" -->
                                            <li
                                                class="page-item {{ $pengabdian->currentPage() == $pengabdian->lastPage() ? 'disabled' : '' }}">
                                                <a class="page-link" href="{{ $pengabdian->nextPageUrl() }}"
                                                    aria-label="Next">
                                                    <span aria-hidden="true">Next</span>
                                                    <span class="sr-only">Next</span>
                                                </a>
                                    ...
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination">
                                            ...
                                            <li class="page-item {{ $menu_penunjang->onFirstPage() ? 'disabled' : '' }}">
                                                <a class="page-link" href="{{ $menu_penunjang->previousPageUrl() }}"
                                                    aria-label="Previous">
                                                    <span aria-hidden="true">Previous</span>
                                                    <span class="sr-only">Previous</span>
                                                </a>
                                            ...
                                            @for ($i = 1; $i <= $menu_penunjang->lastPage(); $i++)
                                                <li
                                                    class="page-item {{ $menu_penunjang->currentPage() == $i ? 'active' : '' }}">
                                                    <a class="page-link"
                                                        href="{{ $menu_penunjang->url($i) }}">{{ $i }}</a>
                                                </li>
                                            @endfor

                                            <!-- Tombol "Next" -->
                                            <li
                                                class="page-item {{ $menu_penunjang->currentPage() == $menu_penunjang->lastPage() ? 'disabled' : '' }}">
                                                <a class="page-link" href="{{ $menu_penunjang->nextPageUrl() }}"
                                                    aria-label="Next">
                                                    <span aria-hidden="true">Next</span>
                                                    <span class="sr-only">Next</span>
                                                </a>
                                    ...
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination">
                                            ...
                                            <li class="page-item {{ $capaian_luaran->onFirstPage() ? 'disabled' : '' }}">
                                                <a class="page-link" href="{{ $capaian_luaran->previousPageUrl() }}"
                                                    aria-label="Previous">
                                                    <span aria-hidden="true">Previous</span>
                                                    <span class="sr-only">Previous</span>
                                                </a>
                                            ...
                                            @for ($i = 1; $i <= $capaian_luaran->lastPage(); $i++)
                                                <li
                                                    class="page-item {{ $capaian_luaran->currentPage() == $i ? 'active' : '' }}">
                                                    <a class="page-link"
                                                        href="{{ $capaian_luaran->url($i) }}">{{ $i }}</a>
                                                </li>
                                            @endfor

                                            <!-- Tombol "Next" -->
                                            <li
                                                class="page-item {{ $capaian_luaran->currentPage() == $capaian_luaran->lastPage() ? 'disabled' : '' }}">
                                                <a class="page-link" href="{{ $capaian_luaran->nextPageUrl() }}"
                                                    aria-label="Next">
                                                    <span aria-hidden="true">Next</span>
                                                    <span class="sr-only">Next</span>
                                                </a>
