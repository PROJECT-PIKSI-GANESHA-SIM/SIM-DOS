                            ...
                            <form method="POST" action="{{ route('pendidikan.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input id="bidang_studi" type="text" class="form-control @error('bidang_studi') is-invalid @enderror" name="bidang_studi" value="{{ old('bidang_studi') }}" required >
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input id="nama_institusi" type="text" class="form-control @error('nama_institusi') is-invalid @enderror" name="nama_institusi" value="{{ old('nama_institusi') }}" required >
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input id="lokasi_institusi" type="text" class="form-control @error('lokasi_institusi') is-invalid @enderror" name="lokasi_institusi" value="{{ old('lokasi_institusi') }}" required >
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input id="gelar_singkat" type="text" class="form-control @error('gelar_singkat') is-invalid @enderror" name="gelar_singkat" value="{{ old('gelar_singkat') }}" required >
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input id="gelar_panjang" type="text" class="form-control @error('gelar_panjang') is-invalid @enderror" name="gelar_panjang" value="{{ old('gelar_panjang') }}" required >
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input id="tanggal_berakhir_studi" type="date" class="form-control @error('tanggal_berakhir_studi') is-invalid @enderror datepicker" name="tanggal_berakhir_studi" required>
