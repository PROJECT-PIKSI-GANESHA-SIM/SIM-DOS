...
<div class="card shadow bg-white flex-row card-rounded">
    <div class="card-body my-auto">
        <div class="title">
            ...
            <span class="fw-bold fs-5">DETAIL PENGABDIAN</span>
            <hr>
        </div>
        <main>
            <section class="intro">
                <form method="POST" action="{{ route('pengabdian.update', $pengabdian->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 ">
                        ...
                        <input id="judul_pengabdian" type="text" class="form-control @error('judul_pengabdian') is-invalid @enderror" name="judul_pengabdian" value="{{ $pengabdian->judul_pengabdian }}" disabled>
                    ...
                    <div class="mb-3 ">
                        ...
                        <input id="bidang_keilmuan" type="text" class="form-control @error('bidang_keilmuan') is-invalid @enderror" name="bidang_keilmuan" required value="{{ $pengabdian->bidang_keilmuan }}" disabled>
                    ...
                    <div class="mb-3 ">
                        ...
                        <textarea id="latar_belakang" type="text" class="form-control @error('latar_belakang') is-invalid @enderror" name="latar_belakang" required style="height: 100px;" disabled>{{ $pengabdian->latar_belakang }}</textarea>
                    ...
                    <div class="mb-3 ">
                        ...
                        <textarea id="manfaat" type="text" class="form-control @error('manfaat') is-invalid @enderror" name="manfaat" required style="height: 100px;" disabled>{{ $pengabdian->manfaat }}</textarea>
                    ...
                    <div class="mb-3 ">
                        ...
                        <input id="sasaran" type="text" class="form-control @error('sasaran') is-invalid @enderror" name="sasaran" required value="{{ $pengabdian->sasaran }}" disabled>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input id="tahun_pelaksanaan" type="date" class="form-control @error('tahun_pelaksanaan') is-invalid @enderror datepicker" name="tahun_pelaksanaan" required value="{{ $pengabdian->tahun_pelaksanaan }}" disabled>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input id="lama_kegiatan" type="text" class="form-control @error('lama_kegiatan') is-invalid @enderror" name="lama_kegiatan" required value="{{ $pengabdian->lama_kegiatan }}" disabled>
                    ...
                    <div class="mb-3">
                        ...
                        <input id="lokasi_pelaksanaan" type="text" class="form-control @error('lokasi_pelaksanaan') is-invalid @enderror" name="lokasi_pelaksanaan" required value="{{ $pengabdian->lokasi_pelaksanaan }}" disabled>
                    ...
                    <div class="mb-3">
                        ...
                        <input id="biaya_kegiatan" type="text" class="form-control @error('biaya_kegiatan') is-invalid @enderror" name="biaya_kegiatan" required value="{{ $pengabdian->biaya_kegiatan }}" disabled>
                    ...
                    <div class="mb-3">
                        ...
                        <input id="kelompok_target" type="text" class="form-control @error('kelompok_target') is-invalid @enderror" name="kelompok_target" required value="{{ $pengabdian->target }}" disabled>
                    ...
                    <div class="mb-3 ">
                        ...
                        <textarea id="kendala" type="text" class="form-control @error('kendala') is-invalid @enderror" name="kendala" required style="height: 100px;" disabled>{{ $pengabdian->kendala }}</textarea>
                    ...
                    <div class="mb-3 ">
                        ...
                        <textarea id="hasil" type="text" class="form-control @error('hasil') is-invalid @enderror" name="hasil" required style="height: 100px;" disabled>{{ $pengabdian->hasil }}</textarea>
                    ...
                    <div class="mb-3 ">
                        ...
                        <textarea id="evaluasi" type="text" class="form-control @error('evaluasi') is-invalid @enderror" name="evaluasi" required style="height: 100px;" disabled>{{ $pengabdian->evaluasi }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <input id="link_publikasi" type="text" class="form-control @error('link_publikasi') is-invalid @enderror" name="link_publikasi" required value="{{ $pengabdian->link_publikasi }}" disabled>
