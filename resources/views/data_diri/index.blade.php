                ...
                <div class="card-body my-auto">
                    <div class="title d-flex align-items-center justify-content-between">
                        ...
                        <a href="{{ route('identitas.edit', $identitas[0]->id) }}" class="justify-content-end">
                            <img class="" src="{{ asset('assets/edit.png') }}" alt="" width="25px"
                                height="25px">
                        </a>
                    </div>
                    <hr>
                    ...
                    <div class="row">
                        <div class="col-md-12  d-flex align-items-center justify-content-center">
                            ...
                            @else
                                <img src="{{ Storage::url('dosen/profile/' . $user->image) }}" class="rounded-circle"
                                    alt="Profile Picture" width="100px" height="100px">
                            @endif
                        </div>
                    </div>
                ...
                <div class="card-body my-auto">
                    ...
                    <div class="items mt-5 me-5 ms-5">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-6">{{ $alamat_kontak[0]->kecamatan }}</div>
                        </div>
                        <div class="row mb-2">
            ...
            <div class="card shadow bg-white flex-row card-rounded">
                <div class="card-body my-auto">
                    <div class="title d-flex align-items-center justify-content-between">
                        ...
                        <a href="{{ route('lain.edit', $lain_lain[0]->id) }}" class="justify-content-end">
                            <img class="" src="{{ asset('assets/edit.png') }}" alt="" width="25px"
                                height="25px">
                        </a>
                    </div>
            ...
            <div class="card shadow bg-white flex-row card-rounded">
                <div class="card-body my-auto">
                    <div class="title d-flex align-items-center justify-content-between">
                        ...
                        <a href="{{ route('kepegawaian.edit', $kepegawaian[0]->id) }}" class="justify-content-end">
                            <img class="" src="{{ asset('assets/edit.png') }}" alt="" width="25px"
                                height="25px">
                        </a>
                    </div>
