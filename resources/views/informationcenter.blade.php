...
<style>
    ...
    .card {
        ...
        /* Menambahkan border pada card dengan ketebalan 3px */
        box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);
        /* Efek shadow (bayangan) pada card */
        transition: border-color 0.3s, box-shadow 0.3s;
        /* Efek transisi untuk perubahan warna border dan shadow */
    }

    .card:hover {
        border-color: #8A00B9;
        /* Warna ungu untuk border ketika dihover */
        box-shadow: 0 6px 8px rgba(0, 0, 0, 0.2);
        /* Efek shadow lebih kuat saat dihover */
    }
